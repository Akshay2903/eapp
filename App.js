...
function App(){
  ...
  const fetchMoviesHandler = useCallback(async ()=> {
    ...
    try{
        ...
        const response = await fetch('https://react-http-c36d9-default-rtdb.firebaseio.com/movies.json')
        if(!response.ok){
    ...
    async function addMoviesHandler(movie){
       const response = await fetch('hhttps://react-http-c36d9-default-rtdb.firebaseio.com/movies.json' , {
            method:'POST',
